...
class CategoryRightItem extends StatefulWidget {
  ...
  CategoryRightItem({this.category,this.isSectionHighlight,this.itemHighlightIndex,this.onSectionPress,this.onItemPress});

  @override
  _CategoryRightItemState createState() => _CategoryRightItemState();
}

class _CategoryRightItemState extends State<CategoryRightItem> {
