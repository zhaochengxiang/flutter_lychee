...
class YYSectionWidget extends StatelessWidget {
  final String title;
  ...
  YYSectionWidget({@required this.title,this.titleTextStyle,this.subtitle,this.subtitleTextStyle,this.height = 40.5,this.onPressed});
