package com.wanjuanlink.lychee.crossplatform.handlers;
...
public class CrossPlatformServiceMessageToNative implements MessageHandler<Boolean>{
    ...
    public static void register(){
        ServiceGateway.sharedInstance().registerHandler(new CrossPlatformServiceMessageToNative());
    }
}
